...
LABEL_INPUT = dir_path + f"/label/{sys.argv[1]}.txt"
PREDICT_INPUT = dir_path + f"/predict/{sys.argv[1]}.txt"
...
if __name__ == "__main__":
    ...
    f1_score, accuracy, recall, precision = evaluate(
        data_length, label_input, predict_input
    )
    print("\n")
